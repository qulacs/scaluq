...
//             result.block(i * rhs.rows(), j * rhs.cols(), rhs.rows(), rhs.cols()) = lhs(i, j) *
//             rhs;
//         }
//     }
//     return result;
...
//                                                              const ComplexMatrix&
//                                                              one_target_matrix, std::uint64_t
//                                                              qubit_count) {
...
//         //         eps<Prec>); if (std::abs(matrix(i, j).real() - test_rand_observable(i,
//         j).real())
//         //         > 1e-6) {
//         //             std::cerr << test_rand_observable(i, j).real() << ' ' << matrix(i,
//         j).real()
//         //                       << std::endl;
//         //         }
//         //         if (std::abs(matrix(i, j).imag() - test_rand_observable(i, j).imag()) > 1e-6)
//         {
//         //             std::cerr << test_rand_observable(i, j).imag() << ' ' << matrix(i,
//         j).imag()
//         //                       << std::endl;
//         //         }
//         //     }
...
int main() {
    ...
    {
        PauliOperator<Precision::F64, ExecutionSpace::Default> pauli(3, "X 0 Y 1 Z 2", 1.0);
