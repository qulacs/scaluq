...
FLOAT_AND_SPACE(Fp, Sp)
void StateVectorBatched<Fp, Sp>::set_state_vector(const StateVector<Fp>& state) {
...
FLOAT_AND_SPACE(Fp, Sp)
StateVector<Fp> StateVectorBatched<Fp, Sp>::get_state_vector_at(std::uint64_t batch_id) const {
