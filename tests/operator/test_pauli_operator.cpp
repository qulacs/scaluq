...
#define TEST_FOR_PRECISION_AND_SPACE(PREC, SPACE)                                               \
    class PauliOperatorMultiplyTest_##PREC##SPACE                                               \
        : public ::testing::TestWithParam<PauliTestParam<Precision::PREC, SPACE>> {};           \
                                                                                                \
    ...
    INSTANTIATE_TEST_CASE_P(                                                                    \
        ...
        testing::Values(                                                                        \
            PauliTestParam("XX",                                                                \
                           PauliOperator<Precision::PREC, SPACE>("X 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("X 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("I 0", 4.0)),                  \
            PauliTestParam("XY",                                                                \
                           PauliOperator<Precision::PREC, SPACE>("X 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("Y 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("Z 0", StdComplex(0, 4))),     \
            PauliTestParam("XZ",                                                                \
                           PauliOperator<Precision::PREC, SPACE>("X 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("Z 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("Y 0", StdComplex(0, -4))),    \
            PauliTestParam("YX",                                                                \
                           PauliOperator<Precision::PREC, SPACE>("Y 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("X 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("Z 0", StdComplex(0, -4))),    \
            ...
            PauliTestParam("YZ",                                                                \
                           PauliOperator<Precision::PREC, SPACE>("Y 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("Z 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("X 0", StdComplex(0, 4))),     \
            PauliTestParam("ZX",                                                                \
                           PauliOperator<Precision::PREC, SPACE>("Z 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("X 0", 2.0),                   \
                           PauliOperator<Precision::PREC, SPACE>("Y 0", StdComplex(0, 4))),     \
    ...
    INSTANTIATE_TEST_CASE_P(                                                                    \
        ...
        testing::Values(PauliTestParam("X_Y",                                                   \
                                       PauliOperator<Precision::PREC, SPACE>("X 0", 2.0),       \
                                       PauliOperator<Precision::PREC, SPACE>("Y 1", 2.0),       \
                                       PauliOperator<Precision::PREC, SPACE>("X 0 Y 1", 4.0)),  \
                        PauliTestParam("XY_YX",                                                 \
                                       PauliOperator<Precision::PREC, SPACE>("X 0 Y 1", 2.0),   \
                                       PauliOperator<Precision::PREC, SPACE>("Y 0 X 1", 2.0),   \
                                       PauliOperator<Precision::PREC, SPACE>("Z 0 Z 1", 4.0))), \
        testing::PrintToStringParamName());                                                     \
                                                                                                \
    INSTANTIATE_TEST_CASE_P(                                                                    \
        MultiPauliPauli,                                                                        \
            ...
            for (std::uint64_t i = 0; i < MAX_TERM; i++) {                                      \
                ...
                if (i + 1 < MAX_TERM) {                                                         \
                    ...
                    pauli_string_z += " ";                                                      \
                                                                                                ...
                                                                                                \
            PauliOperator<Precision::PREC, SPACE> expected =                                    \
                PauliOperator<Precision::PREC, SPACE>(pauli_string_x, coef * coef);             \
            PauliOperator<Precision::PREC, SPACE> pauli_y =                                     \
                PauliOperator<Precision::PREC, SPACE>(pauli_string_y, coef);                    \
            PauliOperator<Precision::PREC, SPACE> pauli_z =                                     \
...
TEST_FOR_PRECISION_AND_SPACE(F32, HostSpace)
#endif
#ifdef SCALUQ_FLOAT64
TEST_FOR_PRECISION_AND_SPACE(F64, HostSpace)
#endif
...
#endif
#ifdef SCALUQ_FLOAT32
TEST_FOR_PRECISION_AND_SPACE(F32, DefaultSpace)
#endif
#ifdef SCALUQ_FLOAT64
TEST_FOR_PRECISION_AND_SPACE(F64, DefaultSpace)
#endif
#ifdef SCALUQ_BFLOAT16
TEST_FOR_PRECISION_AND_SPACE(BF16, DefaultSpace)
#endif
#endif
