...
public:
     ...
     * @param message エラーメッセージ
     */
    InoperatableQuantumStateTypeException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    QuantumStateProcessorException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    InvalidQubitCountException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    DuplicatedQubitIndexException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    InvalidControlQubitException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    InvalidQuantumOperatorException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    InvalidObservableException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    NonHermitianException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    InvalidMatrixGateSizeException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    InvalidStateVectorSizeException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    InvalidOpenfermionFormatException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    UndefinedUpdateFuncException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    UnknownPTreePropertyValueException(const std::string& message) : std::logic_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    OperatorIndexOutOfRangeException(const std::string& message) : std::out_of_range(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    QubitIndexOutOfRangeException(const std::string& message) : std::out_of_range(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    MatrixIndexOutOfRangeException(const std::string& message) : std::out_of_range(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    GateIndexOutOfRangeException(const std::string& message) : std::out_of_range(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    ParameterIndexOutOfRangeException(const std::string& message) : std::out_of_range(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    InvalidPauliIdentifierException(const std::string& message) : std::domain_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    InvalidNoiseTypeIdentifierException(const std::string& message) : std::domain_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    MPIRuntimeException(const std::string& message) : std::runtime_error(message) {}
};
...
public:
     ...
     * @param message エラーメッセージ
     */
    MPISizeException(const std::string& message) : std::runtime_error(message) {}
};
