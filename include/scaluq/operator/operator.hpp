...
public:
    ...
    Operator<Prec, ExecutionSpace::Default> to_default_space(const ConcurrentStream& stream) const;
    Operator<Prec, ExecutionSpace::Host> to_host_space() const;
    Operator<Prec, ExecutionSpace::Host> to_host_space(const ConcurrentStream& stream) const;
