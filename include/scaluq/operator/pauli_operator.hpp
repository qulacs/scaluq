...
void bind_operator_pauli_operator_hpp(nb::module_& m) {
    nb::class_<PauliOperator<Prec>>(
        ...
        DocString()
            ...
            .c_str())
        .def(nb::init<StdComplex>(), "coef"_a = 1.0)
        .def(nb::init<const std::vector<std::uint64_t>&,
             ...
             "pauli_id_list"_a,
             "coef"_a = 1.)
        .def(nb::init<std::string_view, StdComplex>(), "pauli_string"_a, "coef"_a = 1.)
        ...
        .def("get_expectation_value",
             nb::overload_cast<const StateVectorBatched<Prec, ExecutionSpace::Default>&>(
                 ...
                 nb::const_),
             "states"_a,
             "Get expectation values of measuring state vectors. "
             "$\\bra{\\psi_i}P\\ket{\\psi_i}$.")
        .def("get_transition_amplitude",
             nb::overload_cast<const StateVector<Prec, ExecutionSpace::Default>&,
        ...
        .def("get_matrix_ignoring_coef",
             ...
             "Get matrix representation of the PauliOperator, but with forcing `coef=1.`Only "
             "the "
