...
DEFINE_NORMAL(abs, F16)
DEFINE_NORMAL(sqrt, F16)
DEFINE_NORMAL(sin, F16)
DEFINE_NORMAL(cos, F16)
DEFINE_NORMAL(exp, F16)
DEFINE_NORMAL(log2, F16)
DEFINE_NORMAL(sinh, F16)
DEFINE_NORMAL(cosh, F16)
#endif
...
DEFINE_NORMAL(abs, BF16)
DEFINE_NORMAL(sqrt, BF16)
DEFINE_NORMAL(sin, BF16)
DEFINE_NORMAL(cos, BF16)
DEFINE_NORMAL(exp, BF16)
DEFINE_NORMAL(log2, BF16)
DEFINE_NORMAL(sinh, BF16)
DEFINE_NORMAL(cosh, BF16)
#endif
}  // namespace scaluq::internal
