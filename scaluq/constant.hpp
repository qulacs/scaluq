...
//! Pauli matrix Y
KOKKOS_INLINE_FUNCTION
matrix_2_2 Y_GATE() { return {0, Complex<double>(0, -1), Complex<double>(0, 1), 0}; }
//! Pauli matrix Z
KOKKOS_INLINE_FUNCTION
...
//! S-gate
KOKKOS_INLINE_FUNCTION
matrix_2_2 S_GATE_MATRIX() { return {1, 0, 0, Complex<double>(0, 1)}; }
//! Sdag-gate
KOKKOS_INLINE_FUNCTION
matrix_2_2 S_DAG_GATE_MATRIX() { return {1, 0, 0, Complex<double>(0, -1)}; }
//! T-gate
KOKKOS_INLINE_FUNCTION
matrix_2_2 T_GATE_MATRIX() {
    return {COSPI8() - Complex<double>(0, SINPI8()),
            0.,
            0.,
            COSPI8() + Complex<double>(0, SINPI8()) * SINPI8()};
}
//! Tdag-gate
KOKKOS_INLINE_FUNCTION
matrix_2_2 T_DAG_GATE_MATRIX() {
    return {
        COSPI8() + Complex<double>(0, SINPI8()), 0., 0., COSPI8() - Complex<double>(0, SINPI8())};
}
//! Hadamard gate
KOKKOS_INLINE_FUNCTION
...
//! Complex<double> values for exp(j * i*pi/4 )
KOKKOS_INLINE_FUNCTION
array_4 PHASE_90ROT() { return {1., Complex<double>(0, 1), -1, Complex<double>(0, -1)}; }
//! Complex<double> values for exp(-j * i*pi/4 )
KOKKOS_INLINE_FUNCTION
array_4 PHASE_M90ROT() { return {1., Complex<double>(0, -1), -1, Complex<double>(0, 1)}; }
}  // namespace scaluq
