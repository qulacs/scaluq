...
|`SCALUQ_HIP_ARCH`|-|AMD GPU のターゲットアーキテクチャ (名前は[Kokkos CMake Keywords](https://kokkos.org/kokkos-core-wiki/get-started/configuration-guide.html)を参照、例: `SCALUQ_HIP_ARCH=AMD_GPU`)|
